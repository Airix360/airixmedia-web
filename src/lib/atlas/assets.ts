...
const productionCandidateRoot = `${atlasRoot}/airix-atlas-production-package-v1` as AtlasPath;
const supportCandidateRoot = `${atlasRoot}/airix-atlas-groups-4-6-7-8-9` as AtlasPath;
...
function candidateScene(definition: typeof sceneDefinitions[number]): AtlasSceneAsset {
  ...
  const base = `${productionCandidateRoot}/02-responsive-crops/${directory}/${directory}`;
  const layerBase = `${productionCandidateRoot}/03-transparent-scene-layers/${directory}/${directory}`;
  return {
    id,
    name,
    district,
    status: "candidate",
    master: `${productionCandidateRoot}/01-master-scenes/${id}-${slug}.png` as AtlasPath,
    responsive: {
...
export const atlasAssetLibrary = library({
  atlasSignal: { name: "Atlas Signal", category: "objects", src: `${supportCandidateRoot}/04-reusable-objects-and-artifacts/svg/obj-0001-atlas-signal.svg`, status: "candidate", decorativeDefault: true },
  danfo: { name: "Danfo bus", category: "transport", src: `${productionCandidateRoot}/05-people-clothing-vehicles-environment/transport/01-danfo-bus.png`, status: "candidate", decorativeDefault: true },
  ferry: { name: "Passenger ferry", category: "transport", src: `${productionCandidateRoot}/05-people-clothing-vehicles-environment/transport/02-passenger-ferry.png`, status: "candidate", decorativeDefault: true },
  professionalWoman: { name: "Professional woman", category: "people", src: `${productionCandidateRoot}/05-people-clothing-vehicles-environment/people/03-professional-woman-tote.png`, status: "candidate", decorativeDefault: true },
  smartCasual: { name: "Smart casual clothing set", category: "clothing", src: `${productionCandidateRoot}/05-people-clothing-vehicles-environment/clothing/08-smart-casual-set.png`, status: "candidate", decorativeDefault: true },
  trustTree: { name: "Trust Tree", category: "vegetation", src: `${productionCandidateRoot}/05-people-clothing-vehicles-environment/vegetation/01-trust-tree.png`, status: "candidate", decorativeDefault: true },
  bridge: { name: "Cable-stayed bridge", category: "landmarks", src: `${productionCandidateRoot}/05-people-clothing-vehicles-environment/landmarks/05-cable-stayed-bridge.png`, status: "candidate", decorativeDefault: true },
  signFrame: { name: "Atlas sign frame", category: "streetDetails", src: `${productionCandidateRoot}/05-people-clothing-vehicles-environment/street-details/01-atlas-sign-frame.png`, status: "candidate", decorativeDefault: true },
  arrivalMarker: { name: "Arrival district marker", category: "districtMarkers", src: `${supportCandidateRoot}/06-district-markers-and-svg-icons/district-markers/marker-01-arrival.svg`, status: "candidate", decorativeDefault: true },
  publishingIcon: { name: "Publishing icon", category: "icons", src: `${supportCandidateRoot}/06-district-markers-and-svg-icons/icons/ico-005-book.svg`, status: "candidate", decorativeDefault: true },
  routeLegend: { name: "Atlas route legend", category: "wayfinding", src: `${supportCandidateRoot}/07-route-map-and-wayfinding-kit/legends/atlas-route-legend.svg`, status: "candidate", decorativeDefault: true },
  atlasLettering: { name: "Airix Atlas lettering", category: "graphics", src: `${supportCandidateRoot}/08-stamp-label-signage-lettering/lettering/lettering-01-airix-atlas.svg`, status: "candidate", decorativeDefault: true },
  warmPaper: { name: "Warm paper texture", category: "textures", src: `${supportCandidateRoot}/09-texture-and-atmosphere-library/paper/tex-paper-01-warm-paper.png`, status: "candidate", decorativeDefault: true },
  fineHalftone: { name: "Fine halftone texture", category: "textures", src: `${supportCandidateRoot}/09-texture-and-atmosphere-library/print/tex-print-01-fine-halftone.png`, status: "candidate", decorativeDefault: true },
});
...
export const atlasAssetRoots = { atlasRoot, productionCandidateRoot, supportCandidateRoot } as const;
