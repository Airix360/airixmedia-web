export type RouteHeroReviewStatus = "approved" | "pending-campus-accuracy-review" | "context-only-pending-rights-review" | "pending-independent-landmark-verification" | "pending-landmark-verification" | "pending-landmark-and-rights-review" | "pending-owner-review";
...
export const routeHeroAssets: Record<RouteHeroAsset["route"], RouteHeroAsset> = {
  ...
  "/book": { route: "/book", day: "/atlas/heroes/airix-consultation-courtyard-booking-day.webp", night: "/atlas/heroes/airix-consultation-courtyard-booking-night.webp", status: "pending-owner-review", internalContext: "Contemporary Nigerian consultation setting. Pending owner review.", subject: "Consultation courtyard", warning: "Owner review remains pending.", alt: "Clients arriving at a landscaped courtyard for a consultation", desktopPosition: "50% 50%", mobilePosition: "58% bottom" },
};
