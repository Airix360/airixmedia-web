...
describe("regional pricing", () => {
  ...
  it("formats the approved NGN base without a dollar sign", () => { expect(formatBasePrice(pricingPackages[0])).toContain("150,000"); expect(formatBasePrice(pricingPackages[0])).not.toContain("$"); });
});
