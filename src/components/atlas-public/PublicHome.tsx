...
export function PublicHome() {
  return <div className={styles.site}>
    ...
    <main id="main-content">
      ...
      <section className={styles.homeGateway}><span>AIRIX MEDIA / CONTACT</span><h2>Where shall we build next?</h2><p>Start with the challenge, not a preselected package.</p><Link href="/contact?form=project&amp;source=/">Discuss a Project <ArrowRight size={18}/></Link></section>
    </main>
    <PublicFooter/>
  </div>;
}
