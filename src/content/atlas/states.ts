...
export const atlasStateContexts: Partial<Record<AtlasStateId, AtlasStateContextRecord>> = {
  ...
  plateau: { id: "plateau", name: "Plateau State", orientation: "Perspective, research and long-view understanding", material: "Granite, paper, timber, mist and highland vegetation", transition: "Highland path · state review prototype" },
  ogun: { id: "ogun", name: "Ogun State", orientation: "Threshold, readiness and practical beginnings", material: "Warm earth, timber, steel, deep green and route markers", transition: "Road and rail junction · state review prototype" },
};
